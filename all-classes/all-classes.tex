\documentclass[nols,nofonts,nobib,nohyper]{tufte-book}
...
\textit{continuation semantics}.\sidenote{See, e.g., \cite{barker2002}, \cite{shan2002},
  \cite{shan2005}, and \cite{barkerShan2015}.} I'd like to start out by saying
...
In these notes, to a large extent we're going to be investigating mechanisms via which
    ...
    phenomena, e.g., \ac{qr} for scope\sidenote{\cite{may},
      \cite{heimKratzer1998}, etc.}, trivalence for presupposition
    projection,\todo{Add citations} and conventional implicature
    for expressives and
    appositives.\sidenote{\cite{potts2005,mccready2010a,gutzmann2015}, etc.}
    \textit{Continuations} provide a powerful abstraction for modeling meaning
    components \enquote{getting high} in a more general, uniform way.\sidenote{This goes beyond just \textit{meaning}, and can be
    generalized to, e.g., phonological and syntactic features.
    See \cite{elliott2019movement}.} This
    ...
    Continuations were originally developed\sidenote{Or rather,
 ...
 One of the \textit{design features} of continuation semantics that is of
    ...
    \todo[inline]{Keep converting to prose from here}
